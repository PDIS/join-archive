...
/* JOIN Crawler Configuration below */
const CONF_FILE = 'Crawler.conf';
const JOIN_URL = 'joinUrl';
const JOIN_COMPLETED_PATH = 'joinCompletedPath';
const JOIN_ENDORSING_PATH = 'joinEndorsingPath';
const IDEA_DETAIL = 'ideaDetail';
const IDEA_SUGGESTION = 'ideaSuggestion';
...
var JOB_URL = [];
var JOIN_DETAIL_URL = '';
var JOIN_SUGGESTION_URL = '';

var fConfig = null;

init();
console.log(JOIN_URL + ":" + config(JOIN_URL));
console.log(JOIN_COMPLETED_PATH + ":" + config(JOIN_COMPLETED_PATH));
console.log(JOIN_ENDORSING_PATH + ":" + config(JOIN_ENDORSING_PATH));
console.log(IDEA_DETAIL + ":" + config(IDEA_DETAIL));
console.log(IDEA_SUGGESTION + ":" + config(IDEA_SUGGESTION));
...
function init() {
    ...
    JOIN_SUGGESTION_URL = config(JOIN_URL) + config(IDEA_SUGGESTION);
    JOIN_COMPLETED_URL = config(JOIN_URL) + config(JOIN_COMPLETED_PATH);
    JOIN_ENDORSING_URL = config(JOIN_URL) + config(JOIN_ENDORSING_PATH);
